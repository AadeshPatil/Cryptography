...
public class SendMailHelp {
	...
	public  void sendMsg(Optional<Users> sender, String email,String Ip,String time) throws MessagingException{
		try {
		...
		String mailBody ="<!doctype html>\r\n"
				...
				+ "                                           Hey "+sender.get().getCompleteName()+" , Your message Sended to admin on "+time+" has decrppeted by ip "+Ip+" .\r\n"
				+ "                                           <br>\r\n"
